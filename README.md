...
ctx.viewer({ endpoint: EP.redis.redis_default, trace: "viewer" })
```
...
.follow({ endpoint: EP.redis.redis_default, fanout: 100, trace: "follow" })
.recommendation({ endpoint: EP.redis.redis_default, fanout: 50, trace: "recs" })
```
