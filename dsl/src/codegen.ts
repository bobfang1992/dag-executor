...
// =====================================================
// Monaco Types Generation (for browser-based editor intellisense)
// =====================================================
 ...
 *
 * Includes:
 * - KeyToken, ParamToken interfaces
 * - ExprNode, PredNode discriminated unions
 * - E and Pred builder APIs
 * - PlanCtx, CandidateSet interfaces
 * - Key and P objects with all registered tokens
 */
function generateMonacoTypes(
  keys: KeyEntry[],
  params: ParamEntry[],
  tasks: TaskRegistry
): string {
 ...
 * Unlike the full TypeScript interfaces, these are inline for readability.
 */
